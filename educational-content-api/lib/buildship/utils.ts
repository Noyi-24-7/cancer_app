...
import { scriptMap } from "../scripts/script-map";
...
export async function executeWorkflow(workflowName: string, args: any) {
  throw new Error(`executeWorkflow helper is not supported in this environment for ${workflowName}.`);
}
