...
/** @ts-ignore */
import { HttpNode } from "../types/workflow/index";
import { nodes } from "../educationalContentProcessor/nodes";
...
export const httpExecutor =
  (workflowNodes: any[]) => async (nodeId: string, args: Record<string, any>) => {
