...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: TranslationScreenWidget.routePath,
          builder: (context, params) => TranslationScreenWidget(),
        ),
        FFRoute(
...
extension GoRouterExtensions on GoRouter {
  ...
  bool shouldRedirect(bool ignoreRedirect) => false;
}
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/Preggos_Logo.png',
                      width: 295.0,
                      fit: BoxFit.contain,
                    ),
                  ),
